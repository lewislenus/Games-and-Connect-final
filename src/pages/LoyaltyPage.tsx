      ...
      <section className="relative py-20 bg-primary-700">
        <div className="container-custom text-white">
          <div className="max-w-2xl">
            <h1 className="text-4xl font-bold mb-4">Loyalty Program & Volunteering</h1>
            <p className="text-xl mb-0">
              Earn rewards for your participation and give back to the community through volunteering.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              We value our active community members and reward your participation through our loyalty program.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="card p-6 text-center">
              ...
              <p className="text-gray-600">
                Earn points by attending events, participating in community activities, 
                referring friends, and engaging in our WhatsApp group.
              </p>
            </div>
            ...
            <div className="card p-6 text-center">
              ...
              <p className="text-gray-600">
                Use your points to get discounts on event tickets, exclusive merchandise, 
                priority registration, and special experiences.
              </p>
            </div>
            ...
            <div className="card p-6 text-center">
              ...
              <p className="text-gray-600">
                Progress through different membership tiers (Bronze, Silver, Gold, Platinum) 
                to unlock additional benefits and recognition.
              </p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Earn 50 points for each major event you attend (Games Day, Beach Party, etc.)
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-bold mb-1">Participate in Trivia Friday</h4>
                  <p className="text-gray-600">
                    Earn 20 points each time you participate in our weekly trivia sessions
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Earn 100 points when you refer a friend who joins the community and attends an event
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Earn 200 points when you volunteer to help organize or run an event
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="section bg-gray-50">
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              As you accumulate points, you'll progress through different membership tiers, 
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="card p-6 border-t-4 border-gray-300">
              ...
              <ul className="space-y-2">
                ...
                <li className="flex items-center">
                  <CheckCircle className="h-5 w-5 text-primary-500 mr-2" />
                  <span className="text-gray-700">Early event notifications</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="h-5 w-5 text-primary-500 mr-2" />
            ...
            <div className="card p-6 border-t-4 border-yellow-400 transform scale-105 shadow-xl z-10">
              <div className="text-center mb-4">
                ...
                <span className="inline-block bg-yellow-100 text-yellow-800 text-xs px-2 py-1 rounded-full mt-2">Popular</span>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Help us create amazing experiences for the community while developing 
                your skills and expanding your network. Volunteering is a great way to 
                give back and earn substantial loyalty points.
              </p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Help plan and execute our events, from logistics to on-site management.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Assist in managing our WhatsApp community, facilitating discussions, and organizing online activities.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Help create engaging content for our social media channels and website.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Capture moments at our events to share with the community and for promotional purposes.</p>
                  </div>
                </div>
              </div>
      ...
      <section className="section bg-primary-50">
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              Volunteering with Games & Connect offers numerous personal and professional benefits.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card p-6">
              ...
              <p className="text-gray-600">
                Gain practical experience in event management, communication, leadership, 
                and other valuable skills that enhance your resume.
              </p>
            </div>
            ...
            <div className="card p-6">
              ...
              <p className="text-gray-600">
                Connect with professionals from various industries and expand your 
                personal and professional network in Accra.
              </p>
            </div>
            ...
            <div className="card p-6">
              ...
              <p className="text-gray-600">
                Earn substantial loyalty points for your volunteer work, 
                helping you progress through membership tiers faster.
              </p>
            </div>
      ...
      <section className="bg-primary-700 py-16">
        <div className="container-custom text-center text-white">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Whether you want to earn rewards through our loyalty program or contribute 
            as a volunteer, there are many ways to get more involved with Games & Connect.
          </p>
